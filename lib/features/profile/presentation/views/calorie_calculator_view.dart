          ...
          body: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  CommonCustomAppBar(title: S.of(context).Calorie_calculator,),
                  const SizedBox(
                    height:17,
                  ),
                  PropertiesLabel(text: S.of(context).select_gender,),
                  Row(
                     children:[
                       Expanded(
                  ...
                  PropertiesLabel(text: S.of(context).Enter_your_age,),
                  const CustomTextField(hintText: "00",fillColor:Colors.white,height:48,
                  calorieCalculator: true,),
                  const SizedBox(
                    height:16,
                  ),
                  PropertiesLabel(text: S.of(context).Enter_your_weight,),
                   CustomTextField(hintText:S.of(context).km,fillColor:Colors.white,height:48,
                    calorieCalculator: true,),
                  const SizedBox(
                    height:16,
                  ),
                  PropertiesLabel(text: S.of(context).Enter_your_height,),
                  CustomTextField(hintText:S.of(context).cm,fillColor:Colors.white,height:48,
                    calorieCalculator: true,),
                  const SizedBox(
                    height:24,
                  ),
                  ...
                  PropertiesLabel(text: S.of(context).times_you_exercise_per_week,),
                  const SizedBox(
                    height:8,
                  ),
